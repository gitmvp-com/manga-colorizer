...
export default function Home() {
  ...
  // Validation
  const canGenerate = mangaImage && generationState !== 'loading';
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Transform your black and white manga images into vibrant colored artwork using advanced AI technology.
              Upload a manga page or panel to bring it to life with intelligent colorization.
            </p>
          </div>
          ...
          <div className="space-y-8">
              ...
              {generationState === 'idle' && (
                <div className="text-center">
                  <button
                    ...
                    className="w-full md:w-auto bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold py-4 px-12 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
                    disabled={!canGenerate}
                    aria-describedby={!canGenerate ? 'upload-instructions' : undefined}
                  >
                  ...
                  {!canGenerate && (
                    <p id="upload-instructions" className="text-sm text-gray-500 dark:text-gray-400 mt-3">
                      Please upload a manga image to start colorization
                    </p>
                  )}
                </div>
              )}
            ...
            {generationState === 'success' && colorizedResult && (
              <ResultDisplay
                ...
                onGenerateAnother={handleColorizeAnother}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-sm text-gray-600 dark:text-gray-400">
                <div className="space-y-2">
                  ...
                  <h3 className="font-medium text-gray-900 dark:text-white">1. Upload Manga</h3>
                  <p>Upload a black and white manga image, panel, or page you want to colorize.</p>
                </div>
                <div className="space-y-2">
                  ...
                  <p>Our AI analyzes the image and intelligently applies vibrant colors to your manga.</p>
                </div>
                <div className="space-y-2">
                  ...
                  <p>View, share, or download your colorized manga in high quality PNG or JPEG format.</p>
                </div>
              </div>
            </div>
          </div>
